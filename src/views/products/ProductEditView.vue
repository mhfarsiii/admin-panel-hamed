<template>
  <div class="product-edit-view">
    ...
    <div v-else-if="product">
      <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">ویرایش محصول</h1>
        <p class="text-gray-600 dark:text-gray-400 mt-1">{{ product.name }}</p>
      </div>
    ...
    <div v-else class="text-center py-12">
      <p class="text-gray-600 dark:text-gray-400 text-lg mb-4">محصول یافت نشد</p>
      <router-link
        to="/products"
        class="inline-block px-6 py-3 bg-primary-600 dark:bg-primary-700 text-white rounded-lg hover:bg-primary-700 dark:hover:bg-primary-800 transition-colors"
      >
